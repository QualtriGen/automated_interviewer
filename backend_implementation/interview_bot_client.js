Qualtrics.SurveyEngine.addOnload(function() {
    ...
    var CONFIG = {
        ...
        BACKEND_URL: 'https://your-backend-server.com', // e.g., 'https://interview-bot.herokuapp.com'
    ...
    // Toggle voice recording (same as original)
    ...
    // Update microphone button appearance (same as original)
    ...
    function makeBackendRequest(requestData) {
        return new Promise(function(resolve, reject) {
            ...
            xhr.open('POST', CONFIG.BACKEND_URL + CONFIG.API_ENDPOINT);
    ...
    function callOrchestrationAgent(userResponse, conversationContext) {
        ...
        return makeBackendRequest(requestData);
    }

    // Get conversation context for orchestrator (same as original)
    ...
    // Determine which specialized agent to use (same as original)
    ...
    // Get the appropriate system prompt (same as original)
    ...
    // Initialize the chat interface (same as original)
    ...
    // Set up event listeners (same as original)
    ...
    // Start the conversation (same as original)
    ...
    // Handle user input (same as original)
    ...
    // Call the appropriate specialized agent through backend
    function callSpecializedAgent() {
        ...
        if (orchestrationState.currentAgent === 'clarification' && orchestrationState.lastAssessment) {
            additionalContext = 'The user\'s last response needs clarification. Missing information: ' + 
        ...
        var requestData = {
            agent_type: orchestrationState.currentAgent,
    ...
    // UI helper functions (same as original)
